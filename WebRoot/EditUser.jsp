    ...
    <tr>
      ...
      <td>
      	<ul class="checklist" style="height:12em;width:24em;">    
			...
			<li>
				<s:checkbox name="alertAdmin" fieldValue="true"  theme="simple"/>				
			    <s:text name="role.alertAdmin"/> 				
			</li>
			<li>
				<s:checkbox name="alerts" fieldValue="true"  theme="simple"/>				
			    <s:text name="role.alerts"/> 				
			</li>
			<li>
			...
			<li>
				<s:checkbox name="dashboard" fieldValue="true" theme="simple"/>	
			    <s:text name="role.dashboard"/>  			    
			</li> 		
			<li>
			...
			<li>
      			<s:checkbox name="schedulerAdmin" fieldValue="true" theme="simple"/>
			    <s:text name="role.schedulerAdmin"/>  
			</li>					
		</ul>
	 </td>		
    </tr>       
