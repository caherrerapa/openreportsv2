...
<div align="center">
  ...
  <table class="dialog" >    
    ...
    <tr>
      <td class="boldText"><s:text name="reportOptions.description"/> <font color="red">*</font></td>
      <td colspan="8">
  ...
  <div id="buttons" class="button-bar">  
        ...
        <input type="submit" onClick="setNoTarget()" class="standardButton" name="submitRunToEmail" value="<s:text name="reportOptions.sendToEmail"/>">    
        <input type="submit" onClick="setNoTarget()" class="standardButton" name="submitRunToFile" value="<s:text name="reportOptions.sendToFile"/>">    
  </div>
  ...
  <div class="importantSmall">   
      <font color="red">* <s:text name="reportOptions.note"/></font>
  </div>    
