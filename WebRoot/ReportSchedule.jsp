...
<div align="center">
  ...
  <table class="dialog" >         
    ...
    <tr>
      <td class="boldText"><s:text name="label.options"/></td>         
      <td colspan="6">     
        <input type="checkbox" name="runToFile" value="true" <s:if test="runToFile">CHECKED</s:if> > <s:text name="reportSchedule.sendToFile"/> 
      </td>
    </tr>  
  </table> 
