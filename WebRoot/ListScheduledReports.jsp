...
<div align="center">
  ...
  <div class="img-report important" id="instructions">
      <s:text name="listScheduledReports.generatedReports"/>  
  </div>  
   
  <s:set name="reports" value="deliveredReports" scope="request" /> 

  <display:table name="reports" class="displayTag" sort="list" decorator="org.efs.openreports.util.HRefColumnDecorator">
    <display:column property="reportName" titleKey="label.name" sortable="true" headerClass="sortable" href="report-files" paramId="fileName" paramProperty="reportFileName"/>                    
    <display:column property="runDate" titleKey="label.runDate" sortable="true" headerClass="sortable" format="{0,date,MM/dd/yyyy h:mm a}" />                                  
    <display:column property="reportDescription" titleKey="label.description" sortable="true" headerClass="sortable"/>  
    <display:column property="removeLink" title="" sortable="true" headerClass="sortable" href="deleteGeneratedReport.action" paramId="fileName" paramProperty="reportFileName"/>                                                     
    <display:setProperty name="basic.empty.showtable" value="true"/>
  </display:table>
