  ...
  <div id="editReportTabs" class="yui-navset" style="width: 675px;">
    ...
    <div class="yui-content">
      ...
      <table>    
        ...
        <s:if test="report.jasperReport || report.birtReport">
        <tr class="a">
          <td colspan="7"><hr><br></td>
        </tr>
        <tr>        
          <td colspan="6">            
            <s:text name="editReport.parameters.autoAdd"/>
          </td>      
          <td colspan="1" class="dialogButtons" >           
            <input class="standardButton" type="submit" name="submitLoad" value="<s:text name="button.autoAdd"/>">       
          </td>             
        </tr>
        <tr class="a">
          <td colspan="7"><hr></td>
        ...
        <tr>        
          <td colspan="6">
          	<s:text name="editReport.parameters.autoCreate"/>            
          </td>      
          <td colspan="1" class="dialogButtons" >           
            <input class="standardButton" type="submit" name="submitLoadAndCreate" value="<s:text name="button.autoCreate"/>">      
          </td>             
        </tr>
        </s:if>
        <tr class="a">
